...
public class RectangleCommand extends DrawingCommand {
	...
	public void draw(DrawingBoard drawingBoard) throws DrawingBoardException {
		...
		drawVerticalLine(x2, y1, y2, drawingBoard, BoardConstants.CHARACTER_LINE_RECTANGLE);
		drawHorizontalLine(x1, x2, y2, drawingBoard, BoardConstants.CHARACTER_LINE_RECTANGLE);
	}
